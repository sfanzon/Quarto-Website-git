...
![Objective suboptimality vs iteration. FC-GCG inserts 11 atoms, then stops at iteration 12 with an exact optimality certificate.](images/convergence.png)
...
![Support size along the run. Proximal-gradient iterates are dense early and sparsify late; FC-GCG never exceeds the solution's sparsity.](images/sparsity.png)
...
![Wall time to solve to relative accuracy $10^{-8}$, dimension up to $n = 200{,}000$. Open markers: iteration cap hit before reaching the tolerance.](images/scaling.png)
