---
title: "Faster identification of faster F1 drivers via time–rank duality"
subtitle: "Technical walkthrough and reproducible R implementation"
author:
  - name: John Fry
...
date: '2024-03-18'
description: >-
  Technical paper-and-code walkthrough reproducing the F1 time-rank duality
  analysis in R.
body-classes: technical-resource-page f1-walkthrough-page
...
::: {.resource-actions aria-label="Resource links"}
[← Project overview](https://www.silviofanzon.com/projects/f1-time-rank-duality/){.primary}
[Published paper](https://www.silviofanzon.com/assets/pdf/journal/2024-Fry-Bri-Fan.pdf)
[GitHub repository](https://github.com/sfanzon/F1-Paper-Code)
...
For a shorter, industry-facing account, read the [project overview](https://www.silviofanzon.com/projects/f1-time-rank-duality/).
...
## 1. From bookmaker odds to win probabilities
...
## 2. Exponential race-time calibration
...
## 3. Time-rank duality and Table 2
...
## 4. Historical regression and Table 3
...
## 5. The correct driver-level comparison
