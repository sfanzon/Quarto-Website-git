...
The current entrypoint and eight partials continue this consolidation and pass
all safety, interaction and visual regression checks. The remaining selectors
that are absent from static source are generated by Quarto, Bootstrap, Algolia
search or runtime navigation and are intentionally retained.
