...
slug: advanced-functional-analysis-2019-20
author:
  - name: Silvio Fanzon
...
- **Functional Analysis**: I will mainly follow Conway [@conway]. Additional references will be taken from Rudin [@rudin-functional] and Bressan [@bressan]
- **Calculus in Normed Spaces**: Mainly following Kesavan [@kesavan]
- **$$L^p$$ spaces**: I will follow the construction of Rudin [@rudin]
- **Sobolev spaces**: The main references are Leoni [@leoni] and Brezis [@brezis]
- **Distributions**: The excellent book by Mitrea [@mitrea]
