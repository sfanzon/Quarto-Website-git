...
slug: calculus-of-variations-2020-21
author:
  - name: Silvio Fanzon
...
categories:
  - Teaching
  - Course Archive
bibliography: ../data/citations/teaching.bib
...
- **Calculus of Variations**: I will follow [@buttazzo],  [@dacorogna], and the wonderful course by Gobbino [@gobbino]
- **Practical Calculus of Variations**: A good reference with lots of examples and guided exercises is Kielhoefer [@kielhoefer]
- **Functional Analysis**: All the topics discussed throughout the course can be found in [@conway]
- **Calculus in Normed Spaces**: Mainly following [@kesavan]. I had to take a couple of lemmas from [@cartan] (in French), but those are quite quick
- **Convex Analysis**: I refer to [@rockafellar] and [@dacorogna-intro]
- **$$L^p$$ spaces**: I will follow the construction of [@rudin]
- **Sobolev spaces**: The main reference is [@leoni]. I will also take something from [@brezis]
- **$$\Gamma$$-convergence**: The book by Braides [@braides]
