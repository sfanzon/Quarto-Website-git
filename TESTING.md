...
|---|---|---|
| `npm run test:quick` | 13 Chromium checks plus 11 generator tests and 6 generated-output guard tests | Local or CI |
| `npm test` | 40 Chromium checks plus 11 generator tests: all-page smoke, interactions, links, navigation | Local or CI |
