...
`docs/` is intentionally tracked: GitHub Pages serves this rendered directory.
There is no deployment workflow in this repository; render locally or in CI,
then commit the resulting `docs/` changes with their canonical source changes.
