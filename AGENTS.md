...
- `PUBLISHING_ARCHITECTURE.md` — canonical target publishing topology, repository ownership, subdomains and migration rules
...
| Publishing / external resource topology | `PUBLISHING_ARCHITECTURE.md` |
...
For any task involving deployment, GitHub Pages, repository ownership, moving
Quarto resources out of the main site, custom domains/subdomains, notes or
technical-resource hosting, or static asset hosting, read
`PUBLISHING_ARCHITECTURE.md` first and treat it as canonical unless the user
explicitly changes that architecture. Do not introduce proxy routing,
...
transitional and do not silently reinterpret either document.
